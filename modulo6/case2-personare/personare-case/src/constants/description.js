export const allDescriptions = [
  {
    name: "O LOUCO",
    description:
      "Antes de mais nada, vamos esclarecer uma coisa. Uma carta só não traz um significado completo. É necessário uma sequência de tiradas para compreender a mensagem correta. O Louco, a princípio, representa um momento de fechamento de ciclo. Isso representa sobretudo que a pessoa está pronta para abrir os seus horizontes e arriscar novas coisas na vida. Além disso, ela indica que é necessário um mergulho na jornada. O momento é propício para enfrentar desafios e mesmo com medo se lançar em direção da oportunidade que estão sendo abertas. Afinal, o Louco no seu sentido literal traz mensagens boas e positivas, basta acolhê-lha e seguir em frente",
  },
  {
    name: "O MAGO",
    description:
  ...
  },
  {
    name: "A IMPERATRIZ",
    description:
      "A Imperatriz nas cartas de tarot carrega uma simbologia muito forte. A figura é de força e se origina na imagem de uma mãe completamente devota aos seus feitos. Isso significa que a sua vida está, acima de tudo, no pico das conquistas e se encontra pronta para ascender. O acúmulo de experiências foram o suficiente para a levar ao espelho de confiança que agora é. Certamente ao tirar a Imperatriz o momento é ideal para iniciar um novo ciclo e colocar em prática o conhecimento. Aliás, nunca esqueça que está a frente dos comandos e a força associada a sabedora a faz ser muito mais do que um sombra, mas uma protagonista da própria história.",
  },
  {
    name: "O PAPA",
    description:
      "Falou em espiritualidade a carta O papa do tarot tem a resposta. A mensagem é de atenção para o lado espiritual. É hora de parar e lembrar que alguns minutos em diálogo com Deus pode ser a chave para resolver muitos problemas. Aproveite portanto para mirar alguns pedidos de mudança em sua vida. O tempo está propicio para o retorno ao seu interior. O momento de meditação é muito importante para organizar as ideias e os sentimentos. Uma aura renovada atrai coisas boas para os diversos âmbitos da vida. Aproveite para se ligar aos seus ancestrais, porque eles são a maior base para tomar decisões e adquirir sabedoria. Tudo pode ser conquistado desde que se dedique para isso e esteja sempre interligado. O papa representa também boas vibrações e inspirações para o fortalecimento do espírito. Alcançando isso saiba que as qualidades a vir com esta carta são: competência, sabedoria e elevação espiritual.",
  },
  {
    name: "OS ENAMORADOS",
    description:
      "Aos que tiram a carta de tarot Enamorados a melhor descrição para defini-lo é: delicadeza, afeição e Beleza. Mas, também quer dizer: insegurança e indecisão. A dúvida e a ansiedade podem estar deixando-o oscilar muito nas decisões. Mudar constantemente de ideias não é aconselhável. Tente se manter mais lúcido, pois a vida não é somente uma história de amor.",
  },
  {
    name: "O CARRO",
    description:
      "O que esperar de um homem montado em uma carruagem puxada por dois cavalos? É bem fácil de compreender, pois o movimento gerado pela figura representa um novo caminho a ser trilhado. Mas, como todo bom cavaleiro, a carruagem precisa ser governada. O olhar para o mesmo lado é um ponto positivo, pois determinar a direção e continuar caminhando vai gerar revelações necessárias para a vida.Outro ponto importante passado pelo O Carro é que as mudanças urgentes estão para acontecer. É preciso coragem para enfrentá-las, pois por trás dos desafios estão o seu maior sonho. A a possibilidade de uma inversão da carta e isso resulta sobretudo em atrasos. Você vai sim alcançar seus objetivos, mas com um tempo a mais previsto",
  },
  {
    name: "A FORÇA",
    description:
      "Talvez seja essa uma das cartas do tarot mais desejadas pelos consultores do baralho. A Força simboliza domínio emocional. É partir dessa qualidade que a superação e a vontade de agir se tornam reais na vida. O ponto forte para superar as barreiras é o amor próprio e é isso que a mulher abrindo a boca com as duas mãos representa. O animal da imagem traz a analogia do instinto animal. A forma com que ela o doma é sinal de que este impulso está sendo dominado por um sentimento mais racional. Para isso a soma de várias tipos de potência foram usadas, sinal que houve uma expansão dos seus domínios.",
  },
  {
    name: "O EREMITA",
    description:
      "Dentre todas as cartas do tarot saiba que O Eremita é sinal de busca. O silêncio será e a reclusão serão pedidas durante este processo, porque com o ato virá a sabedoria e a concentração. Juntos e refletidos tomar decisões ficará muito mais fácil e claro. Aproveite, afinal, para fazer uma viagem em si mesmo e se dedicar ao autoconhecimento. Retiros espirituais e meditações são bem vindas neste tempo. A singularidade do caminho depende da luz interna acesa e forte para iluminar o caminho e fortalecer os alicerces da realização dos seus sonhos.",
  },
  {
    name: "A RODA DA FORTUNA",
    description:
      "Quando pensar em analisar essa carta é preciso ficar atendo nos efeito da roda. Ela literalmente tem altos e baixos e é essa a analogia trazida para a vida. A figura representa a vida e isso inclui a amorosa e a profissional. Portanto há momentos bons e ruins a serem enfrentados. O movimento é o seu principal foco, porque estamos em constantes mudanças.",
  },
  {
    name: "A JUSTIÇA",
    description:
  ...
  },
  {
    name: "A MORTE",
    description:
      "Muita calma nessa hora! Apesar de medonha essa é uma das cartas do tarot que mais indicam positividade. Renovação e mudança são suas duas principais mensagens. No entanto, prepare-se, porque elas serão feitas de forma drástica e nada agradável. Outro aspecto importante de seu simbolismo é o passado. Para que as mudanças necessárias aconteçam e rápido o primeiro passo é superar as coisas que já aconteceram e se soltar para uma nova realidade. A morte si na imagem é sinal de resistência, pois o seu corpo ainda sobrevive.",
  },
  {
    name: "A TEMPERANÇA",
    description:
      "O chamado a atenção para o equilíbrio mental, material, espiritual e sentimental é sua maior mensagem. Busque coisas e situações mais concretas para a vida. A Temperança permeia as bases mais importante da vida: a emoção, a razão e o espírito. O ponto forte da carta é que ela representa a flexibilidade, ou seja, a habilidade de lidar com a situações de forma mais adaptável.",
  },
  {
    name: "O DIABO",
    description:
      "Uma carta como está deve ser levada em consideração, porque ela representa conflitos interiores. O bem e o mal estão se movimentando dentro de si e alguns dilemas vão aparecer na vida. Portanto, antes de tudo, pense bem para tomar uma decisão. Analise as consequências que podem vir a gerar e faça a melhor escolha.",
  },
  {
    name: "A TORRE",
    description:
      "Está para nascer uma carta mais temida do que a “A Torre”. Ela traz consigo um aviso de transformação que pode vir a acontecer a base de rompimentos indesejáveis. É exatamente por isso que a figura mostra as pessoas caindo, porque a ação é do nada e vem dos céus. Portanto prepare-se para enfrentar o caos.",
  },
  {
    name: "A ESTRELA",
    description:
      "Não é de se admirar que a estrela represente em nossas vidas sinal de luz e renovação. Acompanhada da mulher nua ela representa o “deixar para trás”. Sua nudez é sinal de livramento de sentimentos ruins, desapego e prenúncio de otimismo. Sem essa âncoras é possível agora caminhar em direção a uma nova vida.",
  },
  {
    name: "A LUA",
    description:
      "A princípio, os dois cães, as duas torres e as gotas atraídas pela lua são símbolos fortíssimos que anunciam a necessidade de reflexão das direções. Procure esclarecer os sentimento e reanalisar as condutas da vida, porque elas precisam urgentemente de mudanças. Pare para refletir sobre sua vida pessoal e profissional. Pense bem em como as vêm conduzindo até hoje e o que seria necessário mudar. Seu estado físico aparenta ansioso e exausto. Tome cuidado com os aspectos da saúde, pois o caos não é nada agradável para se manter equilibrado. Tente procurar essa mudança. Mude de ambiente isso talvez posso ajudar a achar um lugar mais tranquilo para se desenvolver.",
  },
  {
    name: "O SOL",
    description:
      "Não poderia ser diferente a mensagem quando o assunto é o O Sol. Sua luz é sinal de positividade e está completamente associado aos objetivos e sucesso. Os sentimentos em relação a ela são os mais agradáveis possíveis. Alegria, força, virilidade, intuição pautada sobre a razão são suas maiores qualidades.",
  },
  {
    name: "O JULGAMENTO",
    description:
      "Olhe bem para as características da carta. No topo há um anjo com uma corneta e isso está ligado a “anunciação”. Muitas coisas boas virão se depender dos sinas dessa carta. Em relação ao passado, as coisas que foram plantadas serão colhidas no momento atual e o futuro guarda novas oportunidades para abraçar. A dica é: organize-se mentalmente e use de tudo que cultivou para tomar as melhores decisões. A hora é agora! Devido a importância é possível que os fatos gerem certas ansiedades, então fique atento aos sentimentos.",
  },
  {
    name: "O MUNDO",
    description:
  ...
  },
  {
    name: "2 DE COPAS",
    description:
      "O significado da carta do tarot Dois de Copas está intimamente ligado às relações humanas, como relacionamento e parcerias. Abrange compromissos e cooperação, bem como conexão e harmonia. Quando esta carta dos Arcanos Menores aparece em uma leitura de tarot, geralmente é interpretada de forma muito positiva. Representando as possibilidades de um novo amor e relacionamentos saudáveis, bem como harmonia e equilíbrio em suas interações consigo mesmo e com os outros.",
  },
  {
    name: "3 DE COPAS",
    description:
      "O significado da carta do tarot Três de Copas traz conforto e alívio para uma pessoa que está procurando. Representa encontros sociais, comemorações, espírito de equipe elevado e abundância. Esta carta Arcanos Menores é um sinal de boas-vindas que encerra um período desafiador muitas vezes marcado por tensões e problemas. Agora é a hora de reunir seus amigos e comemorar. O vento finalmente está nas suas costas e está levando você para o sucesso.",
  },
  {
    name: "4 DE COPAS",
    description:
      "O significado da carta do tarot Quatro de Copas demonstra a insatisfação com o estado atual das coisas e a necessidade de refletir sobre onde você está e para onde pretende ir. É uma carta de arcanos menores que indica a existência de coisas boas em nossas vidas que não podemos notar no momento. Portanto, sua aparência pode ser interpretada tanto como um sinal de alerta, quanto como um alerta para as oportunidades que nos cercam. ",
  },
  {
    name: "5 DE COPAS",
    description:
      "A carta Cinco de Copas faz parte do grupo dos Arcanos Menores, e como todas as cartas do baralho de tarot, o Cinco de Copas terá uma leitura diferenciada conforme aparecer em combinação com outras cartas, e de acordo com a pergunta do consulente. Mas de maneira geral é uma carta carregada de emoções negativas, ou foco excessivo em coisas negativas. ",
  },
  {
    name: "6 DE COPAS",
    description:
      "A carta Seis de Copas faz parte do grupo dos Arcanos Menores, e como todas as cartas do baralho de tarot, o Seis de Copas terá uma leitura diferenciada conforme aparecer em combinação com outras cartas, e de acordo com a pergunta do consulente. Mas de maneira geral é uma carta carregada de emoções de nostalgia, e se foca no passado do consulente. ",
  },
  {
    name: "7 DE COPAS",
    description:
      "A carta Sete de Copas faz parte do grupo dos Arcanos Menores, e como todas as cartas do baralho de tarot, o Sete de Copas terá uma leitura diferenciada conforme aparecer em combinação com outras cartas, e de acordo com a pergunta do consulente. Mas de maneira geral é uma carta que aparece quando seus sentimentos de desejo estão em desarmonia com sua força de vontade de alcançar o que almeja.",
  },
  {
    name: "8 DE COPAS",
    description:
      "A carta Oito de Copas faz parte do grupo dos Arcanos Menores, e como todas as cartas do baralho de tarot, o Oito de Copas terá uma leitura diferenciada conforme aparecer em combinação com outras cartas, e de acordo com a pergunta do consulente. Mas de maneira geral é uma carta que aparece quando seus sentimentos de abandono, seja em relação à pessoas, objetivos ou planos.",
  },
  {
    name: "9 DE COPAS",
    description:
      "A carta Nove de Copas faz parte do grupo dos Arcanos Menores, e como todas as cartas do baralho de tarot, o Nove de Copas terá uma leitura diferenciada conforme aparecer em combinação com outras cartas, e de acordo com a pergunta do consulente. Mas de maneira geral é uma carta que aparece quando seus mais profundos desejos estão prestes a se realizar.",
  },
  {
    name: "10 DE COPAS",
    description:
  ...
  },
  {
    ...
    description:
      "A carta Valete de Copas faz parte do grupo dos Arcanos Menores, e como todas as cartas do baralho de tarot, o Valete de Copas terá uma leitura diferenciada conforme aparecer em combinação com outras cartas, e de acordo com a pergunta do consulente. Mas de maneira geral ela representa um momento em que o consulente precisa acolher o seu lado infantil e liberar a sua criança interior. ",
  },
  {
    name: "CAVALEIRO DE COPAS",
    description:
      "A carta Cavaleiro de Copas faz parte do grupo dos Arcanos Menores, e como todas as cartas do baralho de tarot, o Cavaleiro de Copas terá uma leitura diferenciada conforme aparecer em combinação com outras cartas, e de acordo com a pergunta do consulente. Mas de maneira geral ela representa um momento em que o consulente pode receber propostas, boas notícias e convites. Pois há um seguimento bom em sua vida, mantendo sua integridade ao mesmo tempo em que progride.",
  },
  {
    name: "RAINHA DE COPAS",
    description:
      "A carta Rainha de Copas faz parte do grupo dos Arcanos Menores, e como todas as cartas do baralho de tarot, a Rainha de Copas terá uma leitura diferenciada conforme aparecer em combinação com outras cartas, e de acordo com a pergunta do consulente. Mas de maneira geral ela representa um momento sensibilidade, gentileza e afeição, especialmente de figuras femininas. ",
  },
  {
    name: "REI DE COPAS",
    description:
      "A carta Rei de Copas faz parte do grupo dos Arcanos Menores, e como todas as cartas do baralho de tarot, o Rei de Copas terá uma leitura diferenciada conforme aparecer em combinação com outras cartas, e de acordo com a pergunta do consulente. Mas de maneira geral ela representa um momento de honestidade, gentileza e calor humano na vida do consulente.",
  },
  {
    name: "ÀS DE ESPADAS",
    description:
  ...
  },
  {
    name: "REI DE OUROS",
    description:
      "A carta Rei de Ouros é parte do grupo dos Arcanos Menores, sendo uma entre as figuras da corte – juntamente com a Rainha, o Cavaleiro e o Valete. Como todas as cartas do baralho de tarot, o Rei de Ouros terá uma leitura diferenciada conforme aparecer em combinação com outras cartas, e de acordo com a pergunta do consulente. Mas de maneira geral é uma excelente carta para se tirar em uma leitura, representando o poder da perseverança e a possibilidade de recompensas.",
  },
];
